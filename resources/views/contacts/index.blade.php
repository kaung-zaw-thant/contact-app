                  ...
                  @if ($contacts->count())
                      ...
                      <tr>
                        ...
                        <td width="150">
                          ...
                          <a href="/contacts/{{ $contact->id }}/edit" class="btn btn-sm btn-circle btn-outline-secondary" title="Edit"><i class="fa fa-edit"></i></a>
                          <a href="/contacts/{{ $contact->id }}" class="btn-delete btn btn-sm btn-circle btn-outline-danger" title="Delete"><i class="fa fa-times"></i></a>
                        </td>
                      </tr>
                      @endforeach
